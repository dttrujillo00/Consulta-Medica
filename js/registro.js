...
const policlinico = document.getElementById('policlinico');
...
formulario.addEventListener('submit', function(e) {
	...
	checkRequired([nombreCompleto, nombreUsuario, password, numeroMedico, consultorio, policlinico]);
	...
	if (formularioValido) {
		let data = prepareData([nombreCompleto, nombreUsuario, password, numeroMedico, consultorio, policlinico, rol], 'registro');
